...
model = load_model('/home/phung/jnotebook/source/Tuan7.2/stock_dl_model.h5')
...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('index.html', error_message=f"Error fetching data for {stock}: {str(e)}")
